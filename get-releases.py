...
for release in repository.get_releases():
    ...
    if include == "MAJOR" or include == "MINOR" or include == "PATCH":
        if int(version.major) < int(minMajor) or str(version.major) in excludeMajors: 
            continue
    ...
    if include == "MINOR" or include == "PATCH":
        if int(version.major) < int(minMajor) or int(version.minor) < int(minMinor) or str(version.major) in excludeMajors: 
            continue
        ...
        if versionKey in minorDict:
            ...
            minorDict[versionKey] = version
    if include == "PATCH":
        if int(version.major) < int(minMajor) or int(version.minor) < int(minMinor) or int(version.patch) < int(minPatch) or str(version.major) in excludeMajors: 
            continue
